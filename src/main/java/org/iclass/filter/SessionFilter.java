...
public class SessionFilter extends HttpFilter  {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) 
		...
		List<String> logins = List.of("/community/write.jsp","/community/writeAction.jsp",
						"/community/update.jsp","/community/updateView.jsp",
						"/community/updateAction.jsp","/community/delete.jsp","/logout.jsp");
...
//예시 http://localhost:8081/jspBoard/updateAction.jsp?idx=902&content=ㅋㅋㅋ&title=테스트2&page=1 가 실행되지 않도록 함.
	List<String> posts = List.of("/community.writeAction.jsp",
							    "/community.updateAction.jsp",
							    "/loginAction.jsp",
							    "/member/joinAction.jsp",
							    "/community/commentAction.jsp");
	//	-> 하나씩 정의하기 번거롭다면....
	if(request.getServletPath().contains("Action.jsp") && 
